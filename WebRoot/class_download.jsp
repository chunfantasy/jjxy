...
<div align="center">
  <table width="887" height="355" border="1" cellpadding="0" cellspacing="0" background="images/3e.jpg">
    <tr>
      <td height="83" bordercolor="#E9EED7" background="images/3e.jpg" bgcolor="#CCCCCC"><div align="right">
        <h1 align="left" class="STYLE20">武汉理工大学经济学院</h1>
        <h1 align="center" class="STYLE21">课件中心 </h1>
      </div></td>
      <td height="83" bordercolor="#E9EED7" background="images/3e.jpg" bgcolor="#CCCCCC"><div align="right"><img src="images/kjxz02.jpg" width="140" height="81"></div></td>
    </tr>
    <tr>
      <td height="18" colspan="2" bgcolor="#FFFFFF"><table width="799" height="16" border="0" cellspacing="0" cellpadding="0"  bgcolor="#FDE22F">
          <tr>
            <td width="106" height="16" bgcolor="#FFFFFF"><div align="center" class="style7"><a href="index.jsp" target="_parent"><strong>学院首页</strong></a></div></td>
            <td width="1" bgcolor="#FFFFFF"></td>
            <td width="96" bordercolor="#FFFFFF" bgcolor="#FFFFFF"><div align="center" class="STYLE16"><strong>经济学系
              </strong>
            </div>
            <div align="center" class="STYLE16"></div></td>
            <td width="98" bordercolor="#FFFFFF" bgcolor="#FFFFFF"><div align="center" class="STYLE16"><strong>金融学系</strong></div></td>
            <td width="152" bordercolor="#FFFFFF" bgcolor="#FFFFFF"><div align="center" class="STYLE16"><strong>国际经济与贸易系</strong></div></td>
            <td width="110" bordercolor="#FFFFFF" bgcolor="#FFFFFF"><div align="center" class="STYLE16"><strong>电子商务系</strong></div></td>
            <td width="89" bordercolor="#FFFFFF" bgcolor="#FFFFFF"><div align="center" class="STYLE16"><strong>公共课件</strong></div></td>
            <td width="147" bordercolor="#FFFFFF" bgcolor="#FFFFFF">&nbsp;</td>
          </tr>
      </table></td>
    </tr>
	<tr class="style8">
    ...
    <%
 String sql1 = "select ClassFileId,CourseID,DepartmentId,CourseName,TeacherId, ChapterName, FileName, FileAddress, UpdateDate, FileType, FileSize, Course_URL from classfile where DepartmentId='103112116' order by ClassFileId desc";
   ...
   %>
    <tr class="style8">
      <td height="27"><table width="100%"  border="0">
	   ...
	   String fileAddress = rs1.getString("FileAddress");
	   String ChapterName = rs1.getString("ChapterName");
	   String courseName = rs1.getString("CourseName");
	   String teacherId = rs1.getString("TeacherId");
	   String updateDate = rs1.getString("UpdateDate");
      %>
        <tr class="style9">
          <td width="31%" align="left" valign="top" bordercolor="#99FF99" class="style9 style13">·<a href="/jjxy_manager/manage_pages/do_download.jsp?address=<%=fileAddress%>" target="_blank" class="style9" #invalid_attr_id="15px"><%= fileName%></a></td>
          <td width="16%" valign="top" bordercolor="#99FF99" class="style9"><%=courseName%></td>
		  <td width="22%" valign="top" bordercolor="#99FF99" class="style9"><%=ChapterName%></td>
		  <td width="16%" valign="top" bordercolor="#99FF99" class="style9"><%=teacherId%></td>
          <td width="15%" valign="top" bordercolor="#99FF99" class="style9"><%=updateDate%></td>
        </tr>
        <% k++; }%>
      </table></td>
      <td><table width="100%"  border="0">
       ...
       %>
          <tr class="style9">
            <td width="79%" align="left" valign="top" class="style9">·<a href="/jjxy_manager/manage_pages/do_download.jsp?address=<%=newsAddress%>" target="_blank" class="style9"><%=newsName%></a><br>			</td>
    ...
    <tr class="style8">
      ...
      %>
          <tr class="style9">
            <td width="79%" height="20" align="left" valign="top" ><span class="style9">·<a href="/jjxy_manager/manage_pages/do_download.jsp?address=<%=newsAddress%>" target="_blank" class="style9"><%=newsName%></a>
            </span></td>
    ...
    <tr class="style8">
      ...
      %>
          <tr class="style9">
            <td width="79%" height="20" align="left" valign="top" ><span class="style12">·<a href="/jjxy_manager/manage_pages/do_download.jsp?address=<%=newsAddress%>" target="_blank" class="style9"><%=newsName%></a></span></td>
            <td width="21%" align="left" valign="top" background="images/3e.jpg" class="style9"><%=newsDate%></td>
          </tr>
        <% h++;}%>
      </table>	  </td>
      <td height="16"><table width="100%"  border="0">
      ...
      %>
          <tr class="style9">
            <td width="79%" height="20" align="left" valign="top" >·<a href="/jjxy_manager/manage_pages/do_download.jsp?address=<%=newsAddress%>" target="_blank" class="style9"><%=newsName%></a></td>
            <td width="18%" align="left" valign="top" class="style9"><%=newsDate%></td>
          </tr>
        <% j++;}%>
      </table>	  </td>
    ...
    <tr class="style8">
      ...
      %>
        ...
        <% rs1.close(); rs2.close(); rs3.close(); rs4.close(); rs5.close(); rs6.close(); rs7.close(); rs8.close(); dbBean.closeConn();%>      </td>
    </tr>
    <tr class="style8">
      <td height="31" colspan="2" background="images/kuang.gif"><div align="center"><span class="STYLE11">通讯地址:武汉理工大学经济学院 邮政编码：430070</span></div></td>
    </tr>
  </table>
  <p>&nbsp;</p>
</div>
