...
%><title>武汉理工大学经济学院论文管理系统</title>
  ...
  <frame src="student_pages/student_top.jsp" name="topFrame" frameborder="no" scrolling="NO" noresize>
  <frame src="student_pages/student_system.jsp" name="mainFrame" frameborder="no">
