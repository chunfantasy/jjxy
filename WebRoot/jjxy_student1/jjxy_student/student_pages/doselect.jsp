 ...
 //  String user="dbuser"; 
  ...
  String user="sa"; 
   String password="1";
		  ...
		  CallableStatement stmt= conn.prepareCall("{call EW_InsertPaper(?,?,?,?)}");
     	  stmt.setString(1,studentID);
	      stmt.setString(2,paperID);
...
<br>
论文选择成功。<br>
<br><a href="studentinfo.jsp">请点击这里，返回到主页面</a>
<br><br>
<%}
else {%>
<br>
非常抱歉，选择论文失败。<br>
<br><a href="onlineselect.jsp">请点击这里，重新选择</a>
<br><br>
<%}%>
</td></tr></table>
