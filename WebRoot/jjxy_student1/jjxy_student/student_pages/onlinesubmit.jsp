      ...
      cellPadding=0 width="100%" align=center bgColor=#ffffff border=1>
        ...
        <TR>
          <TD vAlign=top>
            ...
            <form name="form1" method="post" action="listrelativity.jsp">
              ...
              <TR>
                <TD bgColor=#75c6c6>
                  <TABLE cellSpacing=1 cellPadding=4 width="100%" border=0>
                    <TBODY>
                    <TR>
                      <TD class=header colSpan=2>自拟题目 - 必填内容(提示：仔细填写如下几项，这样题目被确认的几率大)</TD>
                    </TR>
                    <TR>
                      <TD width="21%" bgColor=#f7ffff>论文题目:</TD>
                      <TD bgColor=#ffffff><INPUT type="text" size=30 
                        name="PaperName">                        
                          此处必填<span class="style1">*</span></TD>
                    </TR>
                    <TR>
                      <TD bgColor=#f7ffff width="21%">论文类型</TD>
                      <TD bgColor=#ffffff><input name="PaperType" type="radio" value="1" checked>
                      毕业论文 &nbsp;&nbsp;&nbsp;<input name="PaperType" type="radio" value="2">学年论文</TD></TR>
                    <TR>
                      <TD bgColor=#f7ffff>选题理由:</TD>
                      <TD bgColor=#ffffff><textarea name="Reasons" cols="30" rows="4"></textarea>
                        请认真填写理由<span class="style1">*</span></TD>
                    </TR>
                    <TR>
                      <TD bgColor=#f7ffff rowspan="4">关键字（至少写5个）:</TD>
                      <TD bgColor=#ffffff>                       
                          <input name="KeyWords1" type="text" maxlength="20" size="30">
                          <span class="style1">*</span>
                          <input name="KeyWords2" type="text" maxlength="20" size="30">
                          <span class="style1">*</span><br>
                          <br>
                          <input name="KeyWords3" type="text" maxlength="20" size="30">
                          <span class="style1">*</span>                          <input name="KeyWords4" type="text" maxlength="20" size="30">
                          <span class="style1">*</span><br>
                          <br>
                          <input name="KeyWords5" type="text" maxlength="20" size="30">
                          <span class="style1">*</span>                          <input name="KeyWords6" type="text" maxlength="20" size="30"><br><br>
                          <input name="KeyWords7" type="text" maxlength="20" size="30">
&nbsp;&nbsp;
<input name="KeyWords8" type="text" maxlength="20" size="30"> 
请认真填写写这篇论文的关键字</TD>
