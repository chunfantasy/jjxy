...
<frameset rows="*" cols="147,*" framespacing="2" frameborder="NO" border="2" bordercolor="#CCCCCC">
  <frame src="student_system_left.jsp" name="leftFrame" frameborder="yes" scrolling="auto" noresize bordercolor="#CCCCCC">
 <frame src="studentinfo.jsp" name="rightFrame" frameborder="yes" bordercolor="#666666">
</frameset>
<noframes><body>
</body></noframes>
</html>
