  ...
  <BR>
    ...
    <TABLE cellSpacing=0 cellPadding=0 width="95%" align=center border=0>
      <TBODY>
        <TR>
          <TD bgColor=#75c6c6>
            <TABLE cellSpacing=1 cellPadding=4 width="100%" border=0>
              <TBODY>
                <TR class=header>
                  <TD colSpan=12><div align="left">个人详细信息--点击查看留言了解论文最新情况</div></TD>
                </TR>
                <TR class=category align=middle>
                  <TD width=67>学生姓名</TD>
                  <TD width="74">专业班级</TD>
                  <TD width="75">指导老师</TD>
                  <TD width="89">副指导老师</TD>
                  
                  
                  <TD width="235">论文题目</TD>
                  <TD width="63">论文类型</TD>
                  <TD width="68">状态</TD>
                  <TD width="41">下载</TD>
                  <TD width="129">查看留言</TD>
                </TR>
				<%while(rs.next()) {%>
                <TR align=middle>
                  ...
                  <TD bgColor=#ffffff><span class="style1"><%if(rs.getString("Name")==null||rs.getString("Name").equals("")) {out.print("未分配导师");i=i+1;}else{%><%= rs.getString("Name")%><%}%></span></TD>
	   ...
	   if(paperName==null)out.print("未选");
            ...
            href="../message.jsp?sid=<%=id%>"><%=rs.getString("CheckMessage")%></a><%} else{%>[暂无留言]<%}%></span></TD>
                </TR>
				<%}%>
              </TBODY>
          </TABLE></TD>
