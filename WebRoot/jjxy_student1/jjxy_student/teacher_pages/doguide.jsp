                ...
                for(int i=1;i<=count;i++)
				 {
                   ...
                   // a表示 学生是否选了题目 b表示是否能做更新  c表示是否更新成功    
				   String a="";
				   String b="";
				   String c="";  
...
%>	
<br>
学生:<font color="#FF0000"><%=studentname%></font>还未选题 ，暂时不能更改其论文状态。<br>
<br><a href="onlineguide.jsp?type=<%=type%>">请点击这里，返回在线指导页面</a>
<br><br>   		             
<% break;} else if((a.equals("1")&b.equals("0")&c.equals("0"))||(a.equals("1")&b.equals("0")&c.equals("1"))) { 
%>			
<br>
学生:<font color="#FF0000"><%=studentname%></font> 已选题目，暂时不能置其论文状态为未选。<br>
<br><a href="onlineguide.jsp?type=<%=type%>">请点击这里，返回在线指导页面</a>
<br><br>   
<% break;} else if((a.equals("1")&&b.equals("1")&&c.equals("0"))||(a.equals("0")&b.equals("1")&c.equals("0"))) { 
%>			
<br>
学生:<font color="#FF0000"><%=studentname%></font> 论文状态更新失败。<br>
<br><a href="onlineguide.jsp?type=<%=type%>">请点击这里，返回管理页面</a>
<br><br>   
<% break;} 
  else { n++;if(n==count) out.print("<br>操作已成功。<br><br><a href='onlineguide.jsp?type="+type+"'>请点击这里，返回管理页面</a><br><br>");  continue;}
