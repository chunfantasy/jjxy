...
<br>
非常抱歉，您提交的论文和题库有重复，提交失败，现在将转入提交页面。<br>
<br><a href="mystudentinfo.jsp">[ 需要转入主页面请点击这里 ]</a><br><br><a href="onlinesubmit.jsp">如果您的浏览器没有自动跳转，请点击这里</a>
<br><br>
<%}
else if(a.equals("1")&b.equals("1")){%>
<br>
您提交的论文已经进入题库，现在将转入提交页面。<br>
<br><a href="mystudentinfo.jsp">[ 需要转入主页面请点击这里 ]</a><br><br><a href="onlinesubmit.jsp">如果您的浏览器没有自动跳转，请点击这里</a>
<br><br>
<%}
else {%>
