...
<%
    ...
    {   String id=(String) session.getValue("id");
	   sql="update teacher set MobilePhone='"+phone+"',Email='"+email+"' where TeacherID='"+id+"'";
...
%>
<br>
您已经成功保存个人资料。<br><br><a href="mystudentinfo.jsp">请点击这里返回</a><br><br>
...
<%
	 ...
	 String id=(String) session.getValue("id");
        sql="update teacher set PassWord='"+newpassword+"',MobilePhone='"+phone+"',Email='"+email+"' where TeacherID='"+id+"'";
