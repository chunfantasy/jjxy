...
String sql="select StudentName,Phone,DepartmentName,Email from student,department where student.DepartmentID=department.DepartmentID and StudentID='"+id+"'";       
        ...
        <TR>
          <TD bgColor=#75c6c6>
            <TABLE cellSpacing=1 cellPadding=4 width="100%" border=0>
              <TBODY>
                <TR class=header>
                  <TD colSpan=7><div align="left">学生详细信息</div></TD>
                </TR>
				...
				<%while(rs.next()) {%>
                <TR align=middle>
                  <TD bgColor=#f7ffff><%=rs.getString("StudentName")%>
           </TD>
                  <TD bgColor=#f7ffff><%=rs.getString("DepartmentName")%>
           
                  <TD bgColor=#ffffff><%=rs.getString("Phone")%> 
            </TD>
                  <TD bgColor=#f7ffff><%=rs.getString("Email")%> 
</TD>
