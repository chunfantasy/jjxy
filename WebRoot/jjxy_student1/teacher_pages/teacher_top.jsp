...
<body>
<table width="100%" height="72" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#99CCFF">
  <tr>
    <td colspan="10" background="../img/headerbg.gif" bgcolor="#0099CC"><div align="center" class="header">经济学院论文管理系统</div></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td width="9%" class="category"><div align="center">个人信息</div></td>
	<td width="12%" class="category"><div align="center">查看新留言</div></td>
    <td width="9%" class="category"><div align="center">在线管理</div></td>
