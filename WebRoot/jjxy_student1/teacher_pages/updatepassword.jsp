 ...
 //  String user="dbuser"; 
  ...
  String user="sa"; 
   String password="1";
       ...
       String sql="select TeacherID,MobilePhone,Email from teacher where TeacherID='"+id+"'";
...
如不需要更改密码，此处请留空 </TD>
                    ...
                    <TR>
                      ...
                      <TD bgColor=#ffffff><INPUT size=25 name="Phone" type="text" value="<%=rs.getString("MobilePhone")%>"> 
                        如您设置新的安全提问，请在此输入答案</TD>
                    </TR>
                    <TR>
