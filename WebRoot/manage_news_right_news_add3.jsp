...
<body>
  <table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          <td width="664" height="25" background="../img/headerbg.gif"> <div align="center" class="header" >添加公告通知<br>　　　（注意：上传图片的名称要和表中的图片名称一致，否则会出错）
              <br>
          </div></td>
        </tr>
        <tr> 
		  ...
		  String maname=(String)session.getValue("manager_Name");
           ...
           %>	
			 ...
			 <input name="newsType" type="hidden" value="3">
             <td>
                <table width="100%" border="0" cellspacing="2" cellpadding="3"> 
                  ...
                  <tr>
                    ...
                    <td align="center" bgcolor="#C0C0C0" class="category"><div align="center" class="style2">
		    ...
		    <input type="hidden" name="newsDeptID" value=<%=maname%>>
                    ...
                    <td width="17%" class="category"><div align="center" class="style2">文件名称:</div></td>
                    <td class="category"><span class="style2">
                      <input name="newsAddress" type="text" id="newsAddress" size="20" maxlength="30" value="doc/">
                    </span></td>
                  </tr>
                  <tr> 
                    <td height="22" align="center" class="category"><span class="style2">上传附件:</span></td>
                  ...
                  <tr> 
                  <td height="21" colspan="4" class="category">                  </tr>
                  <tr>
                    <td height="33" colspan="4" class="category"> 
					<div align="center"> 
