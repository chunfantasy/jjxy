...
<table width="778" height="147" border="0" cellspacing="0" cellpadding="0"  bgcolor="#FFFFCC">
  ...
  <tr>
    <td width="152" height="21"><div align="center"><span class="style2"><a href="index.jsp" target="_blank" >学院首页</a></span></div></td>
...
<table width="801" border="1" cellpadding="0" cellspacing="0" bordercolor="#99FF99">
 <tr> 
    <td height="12" colspan="2" bordercolor="#FFFFFF" bgcolor="#FFFFFF" ><img src="images/software.gif" width="438" height="20"></td>
 </tr>
 <tr>
   <td width="689" height="13" bordercolor="#FFFFFF" bgcolor="#FFFFFF" ><div align="left"><span class="STYLE4">软件名称</span></div></td>
   <td width="106" height="13" bordercolor="#FFFFFF" bgcolor="#FFFFFF" ><div align="left"><span class="STYLE4">发布时间</span></div></td>
 </tr>
  <%
   request.setCharacterEncoding("gb2312");
   String Type=request.getParameter("type");
   String TypeID=request.getParameter("typeID");
   String sql = "select newsID,newsName,newsAddress,newsDate from news where newsType='9' ";
  %>
  ...
  <tr>
    <td height="26" valign="middle" bgcolor="#FFFFFF"><span class="STYLE5"><a href="<%= rs.getString("NewsAddress")%>" target="_blank">·<%= rs.getString("NewsName")%></a></span></td>
    <td height="26" valign="middle" bordercolor="#FFE8D5" bgcolor="#FFFFFF"><span class="STYLE5">·<%= rs.getString("newsDate")%></a></span></td>
  </tr>
  <%}}
     }//try
...
background= border=0 bgcolor="#FFE8D5">
  ...
  <TR>
    <TD class=unnamed1 height=42>
      <TABLE cellSpacing=0 cellPadding=0 width=751 align=center border=0>
        ...
        <TR>
          <TD width=409>通讯地址:武汉理工大学经济学院实验中心 邮政编码：430070<BR>
          </TD>
